      ...
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          <div className="px-5 py-2">
            <Link href="#about" className="text-base text-slate-500 hover:text-slate-900">
              About
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="#faq" className="text-base text-slate-500 hover:text-slate-900">
              FAQ
            </Link>
          </div>
          <div className="px-5 py-2">
          ...
          <div className="px-5 py-2">
            <Link href="#contact" className="text-base text-slate-500 hover:text-slate-900">
              Contact
            </Link>
          </div>
        </nav>
        ...
        <div className="mt-8 flex justify-center items-center">
          ...
          <p className="ml-2 text-center text-base text-slate-400">&copy; 2025 SocialVerify. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
